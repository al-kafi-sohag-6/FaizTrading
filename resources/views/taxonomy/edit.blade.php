  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
          ...
          <img src="{{ $category->category_image }}" style="height:250px; width:250px; object-fit:contain;">
          @else
          Image not uploded yet
          @endif
      </div>   
      <div class="form-group">
        {!! Form::label('category_image', 'Category Image:*') !!}
          {!! Form::file('category_image', ['class' => 'form-control', 'required', 'accept' => 'image/*']); !!}
      </div>
