<table style="width:100%; font-size: 10px">
	...
	<tbody>
		<tr>
			<td class="text-center" style="line-height: 15px !important; padding-top: 10px !important; padding-bottom: 10px !important;  font-size: 10px; !important">
...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50">
		...
		@if(!empty($receipt_details->total_paid))
			<div class="text-right font-15 color-555">
...
<div class="row color-555">
	<div class="col-xs-12">
		...
		<table class="table table-bordered table-no-top-cell-border table-slim">
			<thead>
				<tr style="background-color: #357ca5 !important; color: white !important; font-size: 10px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					...
					@if ($receipt_details->line_discount_label)
					<td style="background-color: #357ca5 !important; color: white !important;width: 10% !important;">
			...
			<tbody>
				@foreach($receipt_details->lines as $line)
					<tr>
						...
						@if($receipt_details->line_discount_label && $line['line_discount'] > 0)
						<td class="text-right">
							{{$line['line_discount']}}b
						</td>
						@endif
						<td class="text-right">
							{{$line['tax']}}
	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				@php $total_custom_price = 0; @endphp
				
				@foreach($receipt_details->lines as $custom_price)
				
					@php $total_custom_price += $custom_price['unit_price_before_discount']; @endphp
				...
				@foreach($receipt_details->lines as $custom_tax_count)
				
					@php $total_tax += $custom_tax_count['tax']; @endphp
