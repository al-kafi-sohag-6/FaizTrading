...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/due/transaction/{customer_id}', 'SellController@dueTransaction');
    ...
    Route::post('/sells/previous/transactions', 'SellPosController@previoustransactions');
    ...
    Route::post('/sells/pos/get-customer-dues', 'SellPosController@getCustomerDues');
    ...
    Route::get('/sells/pos/get-product-suggestion', 'SellPosController@getProduct');
    Route::get('/sells/pos/get-variants/{id}', 'SellPosController@getvariants');
