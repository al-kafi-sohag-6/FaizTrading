...
class TransactionUtil extends Util
{
        ...
        foreach ($products as $product) {
            ...
            if (!empty($product['transaction_sell_lines_id'])) {
               ...
               if(!empty($product['sell_line_note'])){
                $product_sele_note=$product_sele_note.$product['sell_line_note'];
               }
               if(!empty($product['product_sele_note'])){
                $product_sele_note=$product_sele_note." ".$product['product_sele_note'];
               }
                $line = [
                    ...
                    'sell_line_note' => $product_sele_note,
    ...
    */
    ...
    public function getDueLists($customer_id)
    {
        $dues = Transaction::leftJoin('contacts', 'transactions.contact_id', '=', 'contacts.id')
                ->where('transactions.contact_id', $customer_id)
                ->where('transactions.payment_status', Transaction::DUE)
                ->select(
                    'transactions.id',
                    'transactions.transaction_date',
                    'transactions.type',
